...
#    Updated: 2023/09/20 14:04:46 by dabdygal         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIB1_DIR = minilibx_macos

INCLUDE_DIR = include

CC = cc

CFLAGS = -Wall -Wextra -Werror -I $(INCLUDE_DIR) -L . -lmlx -framework OpenGL -framework AppKit -fsanitize=address
